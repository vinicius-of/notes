-  É *datacenters* e *hardwares* globalmente distribuídos que estão fisicamente conectados para agir como <mark style="background: #FFB86CA6; color: white">um grande recurso</mark> ao cliente final.
